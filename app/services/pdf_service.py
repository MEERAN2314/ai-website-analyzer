...
class PDFService:
    ...
    async def generate_report(self, analysis_data: Dict) -> str:
        ...
        try:
            ...
            sections = [
                ('🎨 UX Analysis', 'ux_analysis', '#3B82F6'),
                ('🔍 SEO Analysis', 'seo_analysis', '#10B981'),
                ('⚡ Performance Analysis', 'performance_analysis', '#F59E0B'),
                ('📝 Content Analysis', 'content_analysis', '#EF4444')
            ]
